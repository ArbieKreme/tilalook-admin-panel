...
import 'package:tilalookadminpanel/controllers/MenuController.dart';
import 'package:tilalookadminpanel/screens/loading_manager.dart';
...
import 'package:tilalookadminpanel/widgets/side_menu.dart';
      ...
      child: Padding(
        ...
        child: DropdownButtonHideUnderline(
          ...
          items: const [
            ...
            DropdownMenuItem(
              child: Text(
                'Aling Nena\'s Minimart',
              ),
              value: 'Aling Nena\'s Minimart',
            ),
            DropdownMenuItem(
              child: Text(
                'Hapinoy Store',
            ...
            DropdownMenuItem(
              ...
              value: 'Super 8 Grocery',
            ),DropdownMenuItem(
              child: Text(
                'Tindahan ni Luz',
              ),
              value: 'Tindahan ni Luz',
            )
          ],
        )),
      ),
